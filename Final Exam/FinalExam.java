public class FinalExam {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int row = 0; row < array.length; row++) {
            System.out.println("");
            for (int column = 0; column < array.length; column++) {
                if (row == 13 && column != 0 && column != 1 && column <= 12 ) {
                    System.out.print(array[row][column]);
                }
            }
        }
        ...
        for (int row = 0; row < array.length; row++) {
            System.out.println("");
            for (int column = 9; column < array.length; column++) {
                if (column == 9 && row >= 2 && row <= 9 ) {
                    System.out.print(array[row][column]);
                }
            }
        }
        ...
        for (int row = 0; row < array.length; row++) {
            System.out.println("");
            for (int column = 14; column < array.length; column++) {
                if (column == 14 && row >= 1 && row <= 11 ) {
                    System.out.print(array[row][column]);
                }
            }
        }
